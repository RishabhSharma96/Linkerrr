        ...
        <div>
            <div className="h-[91vh] w-full bg-gray-200 flex">
                ...
                <div className="flex justify-center items-center lg:w-[60%] w-[100%] flex-col gap-3">
                    <p className="text-3xl md:text-7xl w-[80%] font-extrabold text-purple-700">Get started with Linkerrr Account.</p>
                    <p className="text-md md:text-lg w-[80%] text-purple-500 ">Get Started with Linkerrr with this username. This will be your identity to the world.</p>
                    <UsernameForm user_name={req?.searchParams?.username} />
                </div>

                <div className="hidden md:flex justify-center items-center w-[40%] pr-10">
                    <Image
